  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="absolute bottom-full right-0 z-50 mb-2 w-72 rounded-2xl border border-gray-200 bg-white p-4 shadow-2xl dark:border-gray-700 dark:bg-gray-900"
      >
        <div className="mb-1 flex items-start justify-center gap-3">
          <div className="flex w-12 flex-shrink-0 flex-col items-center gap-1">
            ...
            <span className="text-[9px] font-bold tabular-nums text-gray-500 dark:text-gray-400">
              -{incrementLabel}
            </span>
          </div>
          <input
        ...
        <div className="mb-3 flex gap-1">
          {presets.map((preset) => (
            <button
              key={preset.label}
              className="flex-1 rounded-lg border border-gray-200 bg-gray-100 py-1.5 text-[10px] font-bold text-gray-600 transition-colors hover:bg-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
